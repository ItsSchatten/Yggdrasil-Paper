 ...
 * @since 2.1.0
 */
// Roughly an implementation of ChatPaginator, but made to ignore the line's actual length.
// This instead takes the text and converts it to "lines" which may cause the text to go above the chat window.
public final class StringPaginator {
    ...
    public @NotNull String toString() {
        return "com.itsschatten.yggdrasil.StringPaginator{" +
    ...
    public final static class Page {
        ...
        @Override
        public @NotNull String toString() {
            return "com.itsschatten.yggdrasil.Paginator.Page{" +
                    "lines=" + lines +
                    '}';
        }
    }
