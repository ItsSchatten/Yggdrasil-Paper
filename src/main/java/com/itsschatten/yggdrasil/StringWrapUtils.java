...
public class StringWrapUtils {
     ...
     */
    @Contract("_, _, _ -> new")
    public static @NotNull List<String> convertStringToList(final @NotNull String string, String defaultColor, final int characters) {
        ...
        String colorless = string.replace("<reset>", defaultColor);
        ...
        for (int i = 0; i < temp.size(); i++) {
            ...
            if (i == 0) {
                temp.set(i, defaultColor + toSet);
            } else {
                temp.set(i, getLastUsedColor(temp.get(Math.max(0, i - 1))) + getLastUsedModifier(temp.get(Math.max(0, i - 1))) + toSet);
            }
        }
    ...
    public static @NotNull List<Component> convertStringToComponentList(final String string) {
        return convertStringToComponentList(string, null, 30);
    }
    ...
    public static @NotNull List<Component> convertStringToComponentList(final String string, final String defaultColor) {
        return convertStringToComponentList(string, defaultColor, 30);
    }
